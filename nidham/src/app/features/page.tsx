...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "نظام حضور متكامل: GPS + سيلفي (تسجيل حضور من الموبايل بصورة + موقع)، Geofencing 100م، ربط أجهزة ZKTeco/Hikvision، متصفح، تسجيل الإجازات بكل أنواعها.",
    highlights: ["GPS + سيلفي", "Geofencing", "ربط ZKTeco", "إجازات وسلف"],
  },
  {
    icon: "📱",
...
const FAQS = [
  ...
  { q: "هل ينفع أربط جهاز بصمة بنظام HR؟", a: "أيوه. بنربط أجهزة ZKTeco و Hikvision مباشرة. وكمان فيه نظام حضور بديل: GPS + سيلفي من الموبايل — بدون جهاز بصمة." },
      ...
      <section className="max-w-3xl mx-auto px-4 pb-12 text-center">
        <div className="bg-gradient-to-br from-indigo-500 to-violet-600 rounded-3xl p-8 sm:p-12 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a
              href="https://wa.me/201080053809?text=أهلاً، شفت مميزات نِظام وعايز أسأل"
              target="_blank"
