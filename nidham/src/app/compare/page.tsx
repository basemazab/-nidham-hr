...
const COMPARE_FAQS = [
  ...
  },
  {
    ...
    answer: "ZenHR منصة أردنية، بتنافس Bayzat في الخليج. أسعار ZenHR تبدأ من 4 دولار/موظف/شهر (حوالي 200 ج/موظف/شهر) مع حد أدنى 50 موظف = 10,000 ج/شهر. نِظام يبدأ من 0 ج (مجاني) و Pro بـ 2,500 ج/شهر لكل الشركة.",
  },
  {
    question: "هل نِظام مناسب لشركتي الناشئة؟",
    answer: "أكيد. الباقة المجانية تدعم حتى 5 موظفين ببلاش — مفيش بطاقة ائتمان. Starter بـ 750 ج/شهر لحد 25 موظف. Pro بـ 2,500 ج/شهر لحد 100 موظف.",
  },
  {
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {[
            ...
            { icon: "💰", title: "أرخص 60-85%", desc: "باقات تبدأ من مجاني (5 موظفين ببلاش) و Pro بـ 2,500 ج/شهر للـ 100 موظف. Bayvat و ZenHR أغلى بكتير." },
