...
const REASONS = [
  ...
  },
  {
    ...
    desc: "Bayzat و ZenHR أسعارهم بالدولار — 4-7$/موظف/شهر. نِظام بالجنيه المصري: Pro بـ 1,500 ج/شهر للـ 100 موظف. الـ Free plan مجاني للأبد لحد 5 موظفين.",
    stats: ["1,500 ج/شهر لـ 100 موظف", "500 ج/شهر لـ 25 موظف", "مجاني لـ 5 موظفين", "خصم 20% سنوي"],
  },
  {
    icon: "🤖",
