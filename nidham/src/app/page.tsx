...
function CoreModulesSection() {
  const modules = [
    ...
    { icon: "⏰", title: "الحضور والانصراف", desc: "ربط لحظي لأجهزة ZKTeco (Cloud-Push) + GPS-aware من تطبيق الموبايل، أو دخول يدوي، أو استيراد ملف بصمة.", points: ["ZKTeco لحظي (Cloud-Push)", "تثبيت بالـ GPS + Geofence", "استيراد ملف للأجهزة القديمة"] },
