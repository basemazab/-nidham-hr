...
import { SiteWhatsAppCta } from "@/components/site-whatsapp-cta";
    ...
    >
      ...
      <body className="min-h-full flex flex-col font-sans">
        ...
        <ThemeProvider>
          ...
          <PWAInstaller />
          {/* Nidham's product WhatsApp — auto-hides on recruitment pages
              (/apply, /jobs) so job applicants never see the system's number. */}
          <SiteWhatsAppCta />
          </AppProviders>
        </ThemeProvider>
      </body>
