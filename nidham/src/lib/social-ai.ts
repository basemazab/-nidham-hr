...
🧩 مميزات نِظام الحقيقية (استخدمها بدقة — متخترعش مميزات مش موجودة):
- مرتبات بقانون العمل المصري: تأمينات (11% موظف) + ضريبة كسب العمل بالشرائح + بدلات + سلف، وقسيمة PDF لكل موظف، ومراجعة AI بتلقط الأرقام الشاذة قبل الصرف.
- حضور بالـ GPS من الموبايل + ربط أجهزة بصمة ZKTeco + ورديات، والتأخير بيتحسب في المرتب تلقائيًا.
- ⚡ نبض نِظام: بريفينج تنفيذي يومي بالـ AI عن الشركة كلها مع أولويات وخطوات.
- 🎯 توظيف ذكي: نشر الوظيفة + جمع وفرز الـ CVs بالـ AI + أرقام المتقدمين + إشعار فوري بكل متقدم.
- 🌐 مترجم ومحلّل السيرة الذاتية (عربي ⇄ إنجليزي) + أسئلة مقابلة + اختبار مطبوع.
- ⚖️ المستشار القانوني: محضر تحقيق + رأي قانوني بقانون 12/2003 + مسودات قرارات.
- 🛡️ درع الامتثال: تنبيه قبل غرامات مكتب العمل/التأمينات بالقيمة والمادة.
- 💬 صندوق رسائل التسويق: رد آلي على عملاء فيسبوك/إنستجرام بمعلومات الشركة + إرسال كتالوجات + تسجيل في الـ CRM.
- 💼 CRM وعقود + ✦ استوديو تسويق (6 أدوات AI: إعلانات، personas، SEO، صفحات هبوط، leads).
- 🤖 مساعد ذكي بالعامية بينفّذ مهام حقيقية بجملة واحدة.
- أسعار بالجنيه من 750 ج/شهر للشركة كلها + تجربة 14 يوم مجانًا + دعم بالعربي.
- اللينك دايمًا: https://www.nidhamhr.com`;
...
🧩 مميزات نِظام (اعرفها كويس عشان ترد صح — متخترعش حاجة مش موجودة):
HR + مرتبات بقانون العمل المصري + حضور GPS وبصمة + توظيف ذكي (نشر وظائف + جمع وفرز CVs) + CRM + استوديو تسويق AI. وكمان جديد: ⚡ نبض نِظام (بريفينج تنفيذي يومي)، ⚖️ المستشار القانوني (تحقيق ورأي قانوني بقانون 12/2003)، 🌐 مترجم و📄 بانية السيرة الذاتية (ATS)، 💬 رد آلي على السوشيال. أسعار بالجنيه من 750 ج/شهر + تجربة 14 يوم مجانًا. اللينك: https://www.nidhamhr.com`;
